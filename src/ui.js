...
const P = {
  ...
  /* Unique NPC portraits matching each character's appearance */
  npc_darmo: `<svg viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg"><rect width="30" height="30" rx="3" fill="#3a2e0c"/><ellipse cx="15" cy="20" rx="7" ry="7" fill="#c88a58"/><ellipse cx="8" cy="15" rx="2" ry="4" fill="#d8d0c0" opacity=".85"/><ellipse cx="22" cy="15" rx="2" ry="4" fill="#d8d0c0" opacity=".85"/><rect x="8" y="7" width="14" height="6" rx="2" fill="#e0d8cc"/><rect x="7" y="11" width="16" height="2" rx="1" fill="#c0b8b0"/><rect x="11" y="18" width="2" height="2" rx=".5" fill="#241d2e"/><rect x="17" y="18" width="2" height="2" rx=".5" fill="#241d2e"/><rect x="11" y="18" width="1" height="1" fill="#fff" opacity=".5"/><rect x="17" y="18" width="1" height="1" fill="#fff" opacity=".5"/><path d="M10 17q1-1 2 0M18 17q1-1 2 0" stroke="#8a5030" stroke-width=".6" fill="none" opacity=".6"/><path d="M11 24q4 1.5 8 0" stroke="#6a3010" stroke-width="1" fill="none"/></svg>`,
  npc_siti: `<svg viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg"><rect width="30" height="30" rx="3" fill="#6a0030"/><ellipse cx="15" cy="20" rx="7" ry="7" fill="#d4956a"/><ellipse cx="7" cy="18" rx="3" ry="7" fill="#8a1848" opacity=".9"/><ellipse cx="23" cy="18" rx="3" ry="7" fill="#8a1848" opacity=".9"/><rect x="6" y="7" width="18" height="8" rx="4" fill="#8a1848"/><rect x="5" y="13" width="20" height="2.5" rx="1" fill="#6a1040" opacity=".8"/><rect x="11" y="18" width="2" height="2" rx=".5" fill="#241d2e"/><rect x="17" y="18" width="2" height="2" rx=".5" fill="#241d2e"/><rect x="11" y="18" width="1" height="1" fill="#fff" opacity=".5"/><rect x="17" y="18" width="1" height="1" fill="#fff" opacity=".5"/><path d="M11 24q4 2 8 0" stroke="#8a4020" stroke-width="1" fill="none"/></svg>`,
  npc_dodi: `<svg viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg"><rect width="30" height="30" rx="3" fill="#1040a0"/><ellipse cx="15" cy="21" rx="6" ry="6" fill="#d4956a"/><rect x="9" y="8" width="12" height="8" rx="3" fill="#1a3070"/><rect x="11" y="19" width="3" height="3" rx=".5" fill="#241d2e"/><rect x="16" y="19" width="3" height="3" rx=".5" fill="#241d2e"/><rect x="11.5" y="19.5" width="1.5" height="1.5" fill="#fff" opacity=".6"/><rect x="16.5" y="19.5" width="1.5" height="1.5" fill="#fff" opacity=".6"/><path d="M11 25q4 2.5 8 0" stroke="#8a4020" stroke-width="1.2" fill="none"/></svg>`,
  npc_ratna: `<svg viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg"><rect width="30" height="30" rx="3" fill="#1a5020"/><ellipse cx="15" cy="20" rx="7" ry="7" fill="#d4956a"/><rect x="7" y="7" width="16" height="7" rx="3" fill="#2a1810"/><rect x="6" y="12" width="18" height="2" rx="1" fill="#1a1008" opacity=".7"/><circle cx="23" cy="10" r="3.5" fill="#e06080" opacity=".9"/><circle cx="23" cy="10" r="1.8" fill="#f0d050"/><rect x="11" y="18" width="2" height="2" rx=".5" fill="#241d2e"/><rect x="17" y="18" width="2" height="2" rx=".5" fill="#241d2e"/><rect x="11" y="18" width="1" height="1" fill="#fff" opacity=".5"/><rect x="17" y="18" width="1" height="1" fill="#fff" opacity=".5"/><path d="M11 24q4 2.5 8 0" stroke="#7a3010" stroke-width="1" fill="none"/></svg>`,
  npc_hasan: `<svg viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg"><rect width="30" height="30" rx="3" fill="#082040"/><ellipse cx="15" cy="21" rx="7" ry="6" fill="#b07040"/><polygon points="15,3 4,16 26,16" fill="#c8a030"/><ellipse cx="15" cy="16" rx="11" ry="2.5" fill="#a08020" opacity=".8"/><rect x="11" y="19" width="2" height="2" rx=".5" fill="#241d2e"/><rect x="17" y="19" width="2" height="2" rx=".5" fill="#241d2e"/><rect x="11" y="19" width="1" height="1" fill="#fff" opacity=".45"/><rect x="17" y="19" width="1" height="1" fill="#fff" opacity=".45"/><path d="M11 25q4 1.5 8 0" stroke="#6a3010" stroke-width="1" fill="none"/></svg>`,
  npc_lastri: `<svg viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg"><rect width="30" height="30" rx="3" fill="#2a1050"/><ellipse cx="15" cy="20" rx="7" ry="7" fill="#d4956a"/><rect x="8" y="7" width="13" height="7" rx="3" fill="#2a1810"/><circle cx="23" cy="9" r="4.5" fill="#2a1810" stroke="#1a0808" stroke-width=".8"/><rect x="9.5" y="17.5" width="5" height="3" rx=".8" fill="none" stroke="#d0d0e0" stroke-width=".9"/><rect x="15.5" y="17.5" width="5" height="3" rx=".8" fill="none" stroke="#d0d0e0" stroke-width=".9"/><line x1="14.5" y1="19" x2="15.5" y2="19" stroke="#d0d0e0" stroke-width=".9"/><rect x="11" y="18" width="1.5" height="1.5" rx=".3" fill="#241d2e"/><rect x="17.5" y="18" width="1.5" height="1.5" rx=".3" fill="#241d2e"/><path d="M12 24q3 1.5 6 0" stroke="#8a4020" stroke-width="1" fill="none"/></svg>`,
  npc_rudi: `<svg viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg"><rect width="30" height="30" rx="3" fill="#7a2c08"/><ellipse cx="15" cy="20" rx="7" ry="7" fill="#d4956a"/><ellipse cx="15" cy="13" rx="9" ry="6" fill="#1a4499"/><rect x="5" y="13" width="20" height="2" rx="1" fill="#1a3888"/><rect x="5" y="14" width="7" height="2" rx="1" fill="#142878"/><rect x="11" y="18" width="2" height="2" rx=".5" fill="#241d2e"/><rect x="17" y="18" width="2" height="2" rx=".5" fill="#241d2e"/><rect x="11" y="18" width="1" height="1" fill="#fff" opacity=".5"/><rect x="17" y="18" width="1" height="1" fill="#fff" opacity=".5"/><path d="M11 24q4 2.5 8 0" stroke="#7a3010" stroke-width="1" fill="none"/></svg>`,
...
const BADGE_MAP = {
  ...
  'Pak Darmo':         { c:'#5a4a2a', i:'PD', p: P.npc_darmo  },
  'Bu Siti':           { c:'#c06030', i:'BS', p: P.npc_siti   },
  'Dodi':              { c:'#2d6cb5', i:'Do', p: P.npc_dodi   },
  'Ratna':             { c:'#4a8a30', i:'Rt', p: P.npc_ratna  },
  'Pak Hasan':         { c:'#3a7090', i:'PH', p: P.npc_hasan  },
  'Bu Lastri':         { c:'#5a4090', i:'BL', p: P.npc_lastri },
  'Rudi':              { c:'#a9781b', i:'Ru', p: P.npc_rudi   },
