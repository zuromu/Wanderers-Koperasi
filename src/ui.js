...
const BADGE_MAP = {
  ...
  'Pak Darmo':         { c:'#5a4a2a', i:'PD', p: P.warga     },
  'Bu Siti':           { c:'#c06030', i:'BS', p: P.warga     },
  'Dodi':              { c:'#2d6cb5', i:'Do', p: P.warga     },
  'Ratna':             { c:'#4a8a30', i:'Rt', p: P.warga     },
  'Pak Hasan':         { c:'#3a7090', i:'PH', p: P.warga     },
  'Bu Lastri':         { c:'#5a4090', i:'BL', p: P.warga     },
  'Rudi':              { c:'#a9781b', i:'Ru', p: P.warga     },
